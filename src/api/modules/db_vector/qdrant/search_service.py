...
from src.api.app import QDRANT
from src.api.modules.embeddings.embeddings_service import get_embeddings
from src.api.modules.models.search_result_model import SearchResultModel
